package com.doggynet.topology;

import com.doggynet.topology.client.OAuth2InterceptedFeignConfiguration;
import com.doggynet.topology.config.ApplicationProperties;
import com.doggynet.topology.config.DefaultProfileUtil;
...
public class TopologyApp {
    ...
    public TopologyApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TopologyApp.class);
